...
public class CommonMethods extends PageInitializer {
    ...
    /**
     *this method will click on a radio button or a checkbox by the giveb list of elements and the value
     * @param pattern
     * @return
     */
     ...
     * @param frameIndex
     */
    public static void swtichToFrame(int frameIndex) {
        try {
    ...
    public static void selectDDValue(WebElement dd, int index) {
        ...
        /**
         * this method will switch to a frame by the given name of id
         * @param nameOrId
         */
    public static void swtichToFrame(String nameOrId){
            try {
